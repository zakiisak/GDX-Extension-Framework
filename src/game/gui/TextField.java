...
public class TextField extends TextWriter {
	...
	{
		this(x, y, width, height, GuiDefaults.DefaultFont, "");
	}
	...
	{
		this(x, y, GuiDefaults.DefaultFont, text);
	}
	...
	public void render(SpriteBatch batch) {
		...
		if(caretVisible && isBound()) DrawUtil.drawFilledRect(batch, x + FontUtils.getWidth(font, text) - 1, y, 1, font.getLineHeight());
	}
