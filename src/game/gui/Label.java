...
public class Label extends Component {
	...
	{
		this(x, y, text, GuiDefaults.DefaultFont, color, allignMode);
	}
	
	public Label(float x, float y, String text, Color color)
	{
		this(x, y, text, GuiDefaults.DefaultFont, color, FontUtils.ALLIGN_LEFT);
	}
	
	public Label(float x, float y, String text)
	{
		this(x, y, text, GuiDefaults.DefaultFont, Color.WHITE, FontUtils.ALLIGN_LEFT);
	}
	
	public Label(float x, float y)
	{
		this(x, y, "", GuiDefaults.DefaultFont, Color.WHITE, FontUtils.ALLIGN_LEFT);
	}
	...
	{
		this(text, GuiDefaults.DefaultFont);
	}
