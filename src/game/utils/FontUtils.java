...
public class FontUtils {
	...
	public static float getHeight(BitmapFont font, String... texts)
	{
		float height = 0;
		for(int i = 0; i < texts.length; i++)
		{
			if(texts[i].isEmpty() == false) {
	...
	public static float getMaxWidth(BitmapFont font, String... texts)
	{
		float width = 0;
		for(int i = 0; i < texts.length; i++)
		{
